...
const dict = {
  ...
  field_region_req:       { en: 'Region/District',      kn: 'ಪ್ರಾಂತ್ಯ/ಜಿಲ್ಲೆ' },
  ...
  err_fill_required_star: { en: 'Please fill all fields', kn: 'ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಖಾನೆಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ' },
  err_fill_required_plain:{ en: 'Please fill all fields.', kn: 'ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಅಗತ್ಯ ಕ್ಷೇತ್ರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ.' },
  ...
  sf_epic:             { en: 'Epic / Source(Optional)',   kn: 'ಮೂಲ ಗ್ರಂಥ(ಐಚ್ಛಿಕ)' },
